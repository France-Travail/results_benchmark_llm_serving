...
Model card for Hermes-2-Pro-Mistral-7B_AWQ-GEMM_4_128_True on A100-80g
======================================================================
...
|Metric|Value|
| :---: | :---: |
|Prompt ingestion speed|~12000 t/s |
|Mean generation speed for 10 parallel requests with a prompt of 1024 tokens and 128 tokens generated|~44 t/s for each request|
|Estimate of the max nb of tokens in KV cache|~500k tokens |
...
|Parameter|Value|
| :---: | :---: |
|model|Hermes-2-Pro-Mistral-7B_AWQ-GEMM_4_128_True|
|step_live_metrics|0.01|
|max_queries|1000|
|request_rate|0|
|backend|happy_vllm|
|suite_id|2024-07-30, 06:43:41|
|happy_vllm_version|1.1.3|
|vllm_version|0.4.3|
|host|0.0.0.0|
|port|8501|
|model_name|Hermes-2-Pro-Mistral-7B_AWQ-GEMM_4_128_True|
|app_name|happy_vllm|
