...
Model card for CodeLlama-13B-Instruct-AWQ on A100-40g
=====================================================
...
|Metric|Value|
| :---: | :---: |
|Prompt ingestion speed|~6500 t/s |
...
|Parameter|Value|
| :---: | :---: |
|model|CodeLlama-13B-Instruct-AWQ|
|step_live_metrics|0.01|
|max_queries|1000|
|request_rate|0|
|backend|happy_vllm|
|suite_id|2024-07-10, 07:56:44|
|happy_vllm_version|1.1.3|
|vllm_version|0.4.3|
|host|0.0.0.0|
|port|8501|
|model_name|CodeLlama-13B-Instruct-AWQ|
|app_name|happy_vllm|
