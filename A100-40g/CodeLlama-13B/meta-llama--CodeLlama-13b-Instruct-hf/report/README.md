...
Model card for CodeLlama-13b-Instruct-hf on A100-40g
====================================================
...
|Metric|Value|
| :---: | :---: |
|Prompt ingestion speed|~6750 t/s |
...
|Estimate of the max nb of tokens in KV cache|~0k tokens |
