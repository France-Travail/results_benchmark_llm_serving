...
Model card for Meta-Llama-3-70B-Instruct-AWQ on A100-80g
========================================================
...
|Metric|Value|
| :---: | :---: |
|Prompt ingestion speed|~1000 t/s |
|Mean generation speed for 10 parallel requests with a prompt of 1024 tokens and 128 tokens generated|~8 t/s for each request|
