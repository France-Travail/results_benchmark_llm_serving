...
|Metric|Value|
| :---: | :---: |
|Prompt ingestion speed|~20750 t/s |
|Mean generation speed for 10 parallel requests with a prompt of 1024 tokens and 128 tokens generated|~53 t/s for each request|
