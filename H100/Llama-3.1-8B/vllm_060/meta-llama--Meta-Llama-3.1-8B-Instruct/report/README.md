...
Model card for Meta-Llama-3.1-8B-Instruct on H100
=================================================
...
|Metric|Value|
| :---: | :---: |
|Prompt ingestion speed|~21000 t/s |
|Mean generation speed for 10 parallel requests with a prompt of 1024 tokens and 128 tokens generated|~84 t/s for each request|
|Estimate of the max nb of tokens in KV cache|~525k tokens|
...
|request_rate|0|
|backend|happy_vllm|
|suite_id|2024-09-20, 08:55:22|
|model_name|Meta-Llama-3.1-8B-Instruct|
|happy_vllm_version|1.1.8|
