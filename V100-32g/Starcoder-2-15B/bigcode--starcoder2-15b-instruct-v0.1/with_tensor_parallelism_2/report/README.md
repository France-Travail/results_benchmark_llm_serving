...
Model card for starcoder2-15b-instruct-v0.1 on V100-32g
=======================================================
...
|Metric|Value|
| :---: | :---: |
|Prompt ingestion speed|~2500 t/s |
|Mean generation speed for 10 parallel requests with a prompt of 1024 tokens and 128 tokens generated|~11 t/s for each request|
