...
Model card for Qwen2-7B-Instruct on A100-80g
============================================
...
|Metric|Value|
| :---: | :---: |
|Prompt ingestion speed|~14000 t/s |
|Mean generation speed for 10 parallel requests with a prompt of 1024 tokens and 128 tokens generated|~50 t/s for each request|
|Estimate of the max nb of tokens in KV cache|~950k tokens|
