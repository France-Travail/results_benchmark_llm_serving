...
Model card for CodeLlama-34B-AWQ on A100-80g
============================================
...
|Mean generation speed for 10 parallel requests with a prompt of 1024 tokens and 128 tokens generated|~15 t/s for each request|
...
|request_rate|0|
|backend|happy_vllm|
|suite_id|2024-07-05, 15:07:46|
|happy_vllm_version|1.1.3|
|vllm_version|0.4.3|
|host|0.0.0.0|
|port|8501|
|model_name|CodeLlama-34B-AWQ|
|app_name|happy_vllm|
