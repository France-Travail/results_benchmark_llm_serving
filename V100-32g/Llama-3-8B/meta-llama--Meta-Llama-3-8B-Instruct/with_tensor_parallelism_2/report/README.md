...
|Metric|Value|
| :---: | :---: |
|Prompt ingestion speed|~5250 t/s |
|Mean generation speed for 10 parallel requests with a prompt of 1024 tokens and 128 tokens generated|~24 t/s for each request|
