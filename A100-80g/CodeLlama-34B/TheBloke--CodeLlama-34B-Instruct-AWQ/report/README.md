...
Model card for CodeLlama-34B-Instruct-AWQ on A100-80g
=====================================================
...
|Metric|Value|
| :---: | :---: |
|Prompt ingestion speed|~2750 t/s |
|Mean generation speed for 10 parallel requests with a prompt of 1024 tokens and 128 tokens generated|~14 t/s for each request|
|Estimate of the max nb of tokens in KV cache|~250k tokens |
...
|request_rate|0|
|backend|happy_vllm|
|suite_id|2024-07-05, 15:07:34|
|happy_vllm_version|1.1.3|
|vllm_version|0.4.3|
|host|0.0.0.0|
|port|8501|
|model_name|CodeLlama-34B-Instruct-AWQ|
|app_name|happy_vllm|
