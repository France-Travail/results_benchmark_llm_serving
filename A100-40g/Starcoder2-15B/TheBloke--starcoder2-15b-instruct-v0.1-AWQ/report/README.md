...
Model card for starcoder2-15b-instruct-v0.1-AWQ on A100-40g
===========================================================
...
|Metric|Value|
| :---: | :---: |
|Prompt ingestion speed|~5000 t/s |
...
|Estimate of the max nb of tokens in KV cache|~275k tokens |
...
|Parameter|Value|
| :---: | :---: |
|model|starcoder2-15b-instruct-v0.1-AWQ|
|step_live_metrics|0.01|
|max_queries|1000|
|request_rate|0|
|backend|happy_vllm|
|suite_id|2024-07-22, 13:39:16|
|happy_vllm_version|1.1.3|
|vllm_version|0.4.3|
|host|0.0.0.0|
|port|8501|
|model_name|starcoder2-15b-instruct-v0.1-AWQ|
|app_name|happy_vllm|
