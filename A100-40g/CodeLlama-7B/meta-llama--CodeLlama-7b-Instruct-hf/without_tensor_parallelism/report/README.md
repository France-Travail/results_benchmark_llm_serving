...
Model card for CodeLlama-7b-Instruct-hf on A100-40g
===================================================
...
|Metric|Value|
| :---: | :---: |
|Prompt ingestion speed|~12500 t/s |
|Mean generation speed for 10 parallel requests with a prompt of 1024 tokens and 128 tokens generated|~37 t/s for each request|
